...
if __name__ == "__main__":
    ...
    for i, num in enumerate(range(9, -1, -1), 1):
        btn = tk.Button(root,text=num,command=button_click, font=("Times New Roman", 30))
    ...
    btn = tk.Button(root,text="00", font=("Times New Roman", 30))
    btn.bind("<1>", button_click)
    btn.grid(row=5, column=4, padx=4,pady=3)

    btn = tk.Button(root,text="B", font=("Times New Roman", 30))
    btn.bind("<1>", button_click)
