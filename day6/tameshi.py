...
img_bg = [
    tkinter.PhotoImage(file="py2_samples/Chapter3/image_penpen/chip00.png"),#0
    tkinter.PhotoImage(file="py2_samples/Chapter3/image_penpen/chip01.png"),#1
    tkinter.PhotoImage(file="py2_samples/Chapter3/image_penpen/chip02.png"),#2
    tkinter.PhotoImage(file="py2_samples/Chapter3/image_penpen/chip03.png"),#3
    tkinter.PhotoImage(file="py2_samples/Chapter3/image_penpen/chip002.png")#4
]
img_pen = [
